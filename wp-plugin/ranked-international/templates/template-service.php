  ...
  <section class="svc-hero" id="overview">
    ...
    <div class="svc-wrap svc-hero__grid">
      <div class="svc-hero__copy">
        ...
        <p class="svc-hero__summary"><?php echo esc_html( get_field( 'hero_summary' ) ?: 'Show up in Google Maps and local results when nearby customers are ready to call, book, or visit—not after they have already chosen a competitor.' ); ?></p>
