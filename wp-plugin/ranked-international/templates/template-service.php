...
<header class="nav" id="nav">
  <div class="nav__inner">
    ...
    <nav class="nav__menu" aria-label="Primary"><a href="<?php echo esc_url( home_url( '/' ) ); ?>">Home</a><a href="<?php echo esc_url( home_url( '/#services' ) ); ?>">Services</a><a href="<?php echo esc_url( home_url( '/#industries' ) ); ?>">Industries We Serve</a><a href="<?php echo esc_url( $hub_url ); ?>">Case Studies</a><a href="<?php echo esc_url( home_url( '/contact/' ) ); ?>">Contact</a></nav>
  ...
  <nav class="nav__menu-mobile" id="navMenuMobile"><a href="/">Home</a><a href="/#services">Services</a><a href="/#industries">Industries</a><a href="<?php echo esc_url( $hub_url ); ?>">Case Studies</a><a href="<?php echo esc_url( home_url( '/contact/' ) ); ?>">Contact</a><a href="#audit" class="btn btn--primary btn--block">Get my free audit</a></nav>
</header>
